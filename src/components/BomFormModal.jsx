        ...
        <div className="p-5">
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded px-3 py-2.5 flex justify-between">
          ...
          <div className="flex gap-2 mt-5">
            <button onClick={onClose} className="flex-1 py-3 text-sm border border-gray-300 rounded hover:bg-gray-50 min-h-[44px]">キャンセル</button>
            <button onClick={handleSave} disabled={saving || loading}
              className="flex-1 py-3 text-sm bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 min-h-[44px]">
              {saving ? '保存中...' : '保存'}
            </button>
          </div>
        </div>
